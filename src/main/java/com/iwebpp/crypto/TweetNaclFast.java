...
/**
 * file from <a href=
 * "https://github.com/InstantWebP2P/tweetnacl-java">https://github.com/InstantWebP2P/tweetnacl-java</a>
 * 
 * <br>
...
public final class TweetNaclFast {
	...
	public static final class Box {
		 ...
		 * message for a key pair. Returns an encrypted and authenticated message, which
		 * is nacl.box.overheadLength longer than the original message.
		 */
		 ...
		 * @description Encrypt and authenticates message using peer's public key, our
		 * secret key, and the given nonce, which must be unique for each distinct
		 * message for a key pair. Explicitly pass the nonce Returns an encrypted and
		 * authenticated message, which is nacl.box.overheadLength longer than the
		 * original message.
		 */
		 ...
		 * our secret key, and the given nonce. Returns the original message, or null if
	...
	public static final class SecretBox {
		 ...
		 * The nonce must be unique for each distinct message for this key. Returns an
		 * encrypted and authenticated message, which is nacl.secretbox.overheadLength
		 ...
		 * and the nonce. Returns the original message, or null if authentication fails.
		 */
		public byte[] open(byte[] box) {
			if (box == null)
				return null;
	...
	private static void core_salsa20(byte[] o, byte[] p, byte[] k, byte[] c) {
		int j0 = c[0] & 0xff | (c[1] & 0xff) << 8 | (c[2] & 0xff) << 16 | (c[3] & 0xff) << 24, j1 = k[0] & 0xff | (k[1] & 0xff) << 8 | (k[2] & 0xff) << 16 | (k[3] & 0xff) << 24, j2 = k[4] & 0xff | (k[5] & 0xff) << 8 | (k[6] & 0xff) << 16 | (k[7] & 0xff) << 24, j3 = k[8] & 0xff | (k[9] & 0xff) << 8 | (k[10] & 0xff) << 16 | (k[11] & 0xff) << 24, j4 = k[12] & 0xff | (k[13] & 0xff) << 8 | (k[14] & 0xff) << 16 | (k[15] & 0xff) << 24, j5 = c[4] & 0xff | (c[5] & 0xff) << 8 | (c[6] & 0xff) << 16 | (c[7] &
				0xff) << 24, j6 = p[0] & 0xff | (p[1] & 0xff) << 8 | (p[2] & 0xff) << 16 | (p[3] & 0xff) << 24, j7 = p[4] & 0xff | (p[5] & 0xff) << 8 | (p[6] & 0xff) << 16 | (p[7] & 0xff) << 24, j8 = p[8] & 0xff | (p[9] & 0xff) << 8 | (p[10] & 0xff) << 16 | (p[11] & 0xff) << 24, j9 = p[12] & 0xff | (p[13] & 0xff) << 8 | (p[14] & 0xff) << 16 | (p[15] & 0xff) << 24, j10 = c[8] & 0xff | (c[9] & 0xff) << 8 | (c[10] & 0xff) << 16 | (c[11] & 0xff) << 24, j11 = k[16] & 0xff | (k[17] & 0xff) << 8 | (k[18] &
						0xff) << 16 | (k[19] & 0xff) << 24, j12 = k[20] & 0xff | (k[21] & 0xff) << 8 | (k[22] & 0xff) << 16 | (k[23] & 0xff) << 24, j13 = k[24] & 0xff | (k[25] & 0xff) << 8 | (k[26] & 0xff) << 16 | (k[27] & 0xff) << 24, j14 = k[28] & 0xff | (k[29] & 0xff) << 8 | (k[30] & 0xff) << 16 | (k[31] & 0xff) << 24, j15 = c[12] & 0xff | (c[13] & 0xff) << 8 | (c[14] & 0xff) << 16 | (c[15] & 0xff) << 24;
	...
	public static int crypto_stream_xor(byte[] c, int cpos, byte[] m, int mpos, long d, byte[] n, byte[] k) {
		 ...
		 * " "+n[dbg]; Log.d(TAG, "crypto_stream_xor, nonce -> "+dbgt); dbgt = ""; for
		 * (int dbg = 0; dbg < k.length; dbg ++) dbgt += " "+k[dbg]; Log.d(TAG,
		 * "crypto_stream_xor, shk -> "+dbgt);
		 */
	...
	private static void M(long[] o, final int ooff, long[] a, final int aoff, long[] b, final int boff) {
		long v, c, t0 = 0, t1 = 0, t2 = 0, t3 = 0, t4 = 0, t5 = 0, t6 = 0, t7 = 0, t8 = 0, t9 = 0, t10 = 0, t11 = 0, t12 = 0, t13 = 0, t14 = 0, t15 = 0, t16 = 0, t17 = 0, t18 = 0, t19 = 0, t20 = 0, t21 = 0, t22 = 0, t23 = 0, t24 = 0, t25 = 0, t26 = 0, t27 = 0, t28 = 0, t29 = 0, t30 = 0, b0 = b[0 + boff], b1 = b[1 + boff], b2 = b[2 + boff], b3 = b[3 + boff], b4 = b[4 + boff], b5 = b[5 + boff], b6 = b[6 + boff], b7 = b[7 + boff], b8 = b[8 + boff], b9 = b[9 + boff], b10 = b[10 + boff], b11 = b[11 + boff],
				b12 = b[12 + boff], b13 = b[13 + boff], b14 = b[14 + boff], b15 = b[15 + boff];
	...
	public static int crypto_box_beforenm(byte[] k, byte[] y, byte[] x) {
		 ...
		 * " "+s[dbg]; Log.d(TAG, "crypto_box_beforenm -> "+dbgt); dbgt = ""; for (int
		 * dbg = 0; dbg < x.length; dbg ++) dbgt += " "+x[dbg]; Log.d(TAG,
	...
	private static int crypto_hashblocks_hl(int[] hh, int[] hl, byte[] m, final int moff, int n) {
		...
		while (n >= 128) {
			 ...
			 * Log.d(TAG, "\ncrypto_hashblocks_hl hh -> "+dbgt); dbgt = ""; for (int dbg =
			 * 0; dbg < hl.length; dbg ++) dbgt += " "+hl[dbg]; Log.d(TAG,
