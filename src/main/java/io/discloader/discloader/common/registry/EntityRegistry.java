...
public class EntityRegistry {
	...
	/**
	 * A Map of the client's cached TextChannels. Indexed by {@link IChannel#getID()}.
	 * 
	 * @see IChannel
	 * @see ITextChannel
	 * @see Map
	...
	/**
	 * A HashMap of the client's cached GroupDM channels. Indexed by {@link IChannel#getID()}
	 * 
	 * @see IChannel
	 * @see IGroupChannel
	 * @see Map
	...
	/**
	 * A HashMap of the client's cached PrivateChannels. Indexed by {@link IChannel#getID()}.
	 * 
	 * @see IChannel
	 * @see IPrivateChannel
	 * @see Map
	...
	/**
	 * A Map of the client's cached VoiceChannels. Indexed by {@link IChannel#getID()}.
	 * 
	 * @see IChannel
	 * @see IVoiceChannel
	 * @see Map
	...
	public static IGroupChannel getGroupChannelByName(String name) {
		for (IGroupChannel channel : getGroupChannelsCollection()) {
	...
	/**
	 * Returns a {@link Map}{@literal <}{@link Long}, {@link IGuild}{@literal >} of all of the client's guilds. The {@link Map} is indexed
	 * by {@link IGuild#getID()}
	 * 
	 * @return A {@link Map} of {@link IGuild} objects indexed by {@link IGuild#getID()}
	 * @see IGuild
	...
	public static IPrivateChannel getPrivateChannelByUsername(String username) {
		for (IPrivateChannel channel : getPrivateChannelsCollection()) {
			if (channel.getRecipient().getUsername().equalsIgnoreCase(username)) {
				return channel;
			}
		}
		return null;
