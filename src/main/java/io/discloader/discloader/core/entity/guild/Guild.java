...
public class Guild implements IGuild {
	 ...
	 * @author Perry Berman
	 */
	public HashMap<String, IGuildMember> members;
	 ...
	 * @author Perry Berman
	 */
	public Map<String, IPresence> presences;
	 ...
	 * @author Perry Berman
	 */
	public Map<String, IGuildEmoji> emojis;
	 ...
	 */
	public CompletableFuture<IGuildMember> fetchMember(String memberID) {
	 ...
	 */
	public CompletableFuture<HashMap<String, IGuildMember>> fetchMembers(int limit, String after) {
	 ...
	 * @return A CompletableFuture that completes with a HashMap of GuildMembers if successful, null otherwise.
	 */
	public CompletableFuture<HashMap<String, IGuildMember>> fetchMembers(String after) {
	...
	/*
	 * (non-Javadoc)
	 * @see io.discloader.discloader.entity.guild.IGuild#getEmojis()
	 */
	@Override
	public Map<String, IGuildEmoji> getEmojis() {
		return emojis;
	}
	...
	public CompletableFuture<HashMap<String, Invite>> getInvites() {
		...
		HashMap<String, Invite> invites = new HashMap<>();
		loader.rest.getInvites(this).thenAcceptAsync(action -> {
			for (InviteJSON i : action) {
				invites.put(i.code, new Invite(i, loader));
			}
	 ...
	 */
	@Override
	public Map<String, IGuildMember> getMembers() {
		return members;
	}
	 ...
	 */
	@Override
	public Map<String, IPresence> getPresences() {
		return presences;
	}
	...
	/**
	 * @param iGuildMember The member to check if their the {@link Guild guild's} owner
	...
	public boolean isOwner(IGuildMember iGuildMember) {
		return getOwner().getID().equals(iGuildMember.getID());
	}
	...
	/*
	 * (non-Javadoc)
	 * @see io.discloader.discloader.entity.guild.IGuild#kickMember(io.discloader.discloader.common.entity.guild.GuildMember)
	 */
	@Override
	public CompletableFuture<IGuildMember> kickMember(GuildMember guildMember) {
		return null;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see io.discloader.discloader.entity.guild.IGuild#getMember(java.lang.String)
	 */
	@Override
	...
	@Override
	public IPresence getPresence(String memberID) {
