...
public final class DLUtil {
	...
	/**
	 * An object containing {@link Integer} representations of the different types
	 * of channels in Discord's API
	 * 
	 * @author Perry Berman
	 */
	...
	public static final String LoaderVersion = "0.2.4";
	 ...
	 * {@link GatewayListener SocketListener} before the {@link DiscLoader loader}
	 * has emitted ready.
	 * 
	 * @since v0.0.1
	 */
	public static final ArrayList<String> EventWhitelist = new ArrayList<String>(Arrays.asList(WSEvents.HELLO, WSEvents.READY, WSEvents.GUILD_CREATE, WSEvents.GUILD_DELETE, WSEvents.GUILD_MEMBER_ADD, WSEvents.GUILD_MEMBER_REMOVE, WSEvents.GUILD_MEMBER_UPDATE, WSEvents.GUILD_MEMBERS_CHUNK));
