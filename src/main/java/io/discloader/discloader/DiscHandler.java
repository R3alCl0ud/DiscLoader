package io.discloader.discloader;
...
public class DiscHandler {
	...
	public DiscLoader discLoader;
	private HashMap<String, Object> instances;

	public DiscHandler(DiscLoader discLoader) {
		this.discLoader = discLoader;
				...
				try {
					...
					for (int n = 0; n < methods.length; n++) {
						EventHandler event = methods[n]
								.getAnnotation(io.discloader.discloader.objects.annotations.EventHandler.class);
						if (event != null) {
