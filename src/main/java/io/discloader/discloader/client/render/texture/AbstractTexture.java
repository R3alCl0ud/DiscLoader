...
public abstract class AbstractTexture implements IIcon {
	 ...
	 * (non-Javadoc)
	 * @see
	 * io.discloader.discloader.client.renderer.util.IIcon#setIconHeight(int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * io.discloader.discloader.client.renderer.util.IIcon#setIconWidth(int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * io.discloader.discloader.client.renderer.util.IIcon#setIconName(java.lang
	 * .String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * io.discloader.discloader.client.renderer.util.IIcon#setImage(java.awt.
	 * Image)
	 */
	@Override
