...
public class TabbedPanel extends JPanel {
	...
	public TabbedPanel(DiscLoader loader) {
		...
		tabbedPane.addTab("Users", createImageIcon("texture.gui.icons.missing-icon","Missing Icon"), new UserFolders(this.loader), "Users");
		tabbedPane.addTab("Guilds", createImageIcon("texture.gui.icons.missing-icon","Missing Icon"), new GuildFolders(this.loader), "Guilds");
